  ...
  return (
    <div className='space-y-4'>
        ...
        <div className='flex gap-2'>
            <input type="text" placeholder='Enter a Skill (e.g, Your personal and proffesioanl skills)' className='flex-1 px-3 text-sm ' onChange={(e)=>setNewSkill(e.target.value)}
            value={newSkill}
