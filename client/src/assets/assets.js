...
export const dummyResumeData = [
    {
        // ----------------------------------------------------- Resume 1 ------------------------------------------------------
        personal_info: {
            full_name: "Wajid Khan ",
            email: "wajidkhan123@gmail.com",
            phone: "0 123456789",
            location: "NY, USA",
